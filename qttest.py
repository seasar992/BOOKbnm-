...
if __name__ == '__main__':
    ...
    # widget.setStyleSheet('QWidget{background-color:red;margin:0px; border:0px solid rgb(0, 255, 0);}')
    # "QWidget {border:2px solid black;}"
    # button = QPushButton('button')
    image_label = QLabel()
    image_label.setFrameShape(QFrame.HLine)
    image_label.setFrameStyle(QFrame.NoFrame)
    # image_label.setStyleSheet("margin:0px; border:0px solid rgb(0, 255, 0);");
    ...
    loading_mask = LoadingMask(widget, 'Spinner-1s-200px.gif')
    widget.show()
    loading_mask.show()
